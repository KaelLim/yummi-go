...
const flow: Flow = {
  id: 'first-checkin',
  name: '首次打卡',
  description: '由 pet-name 自動進入首次打卡 → AHA banner → 設用餐時間 → 回 /home（後續打卡則由 /home 進入）',
  order: 2,
  nodes: [
    ...
    { id: 'eat-times',     routePath: '/onboarding/eat-times',          title: '用餐時間',               description: '三餐通知時段',                    x: 2, y: 5 },
    { id: 'home-after',    routePath: '/home',                          title: 'Home（已完成設定）',     description: '回主介面，level-bar 即時更新',       x: 2, y: 6 },
  ],
  edges: [
    ...
    { from: 'success',   to: 'eat-times',  trigger: '繼續守護 (首次：eat_times=null)' },
