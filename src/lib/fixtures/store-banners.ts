...
export const STORE_BANNERS_FIXTURE: StoreBanner[] = [
  {
    ...
    detail_url: 'https://example.com/campaigns/lianxiang',
    partner_name: '蓮香齋',
    monthly_limit: 30,
    sort_order: 1,
  },
  {
    ...
    detail_url: 'https://example.com/campaigns/plantlab',
  ...
  },
  {
    ...
    detail_url: 'https://example.com/campaigns/tzuchi-charity',
    partner_name: '慈濟',
    monthly_limit: null,
    sort_order: 3,
  },
  {
    ...
    cost_gems: 50,
    surveycake_url: null,
    detail_url: 'https://example.com/campaigns/verde-archive',
